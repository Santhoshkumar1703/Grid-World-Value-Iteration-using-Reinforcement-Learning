...
ACTIONS = [(-1, 0), (1, 0), (0, -1), (0, 1)]  # actions in coordinates left ringht up down
REWARDS = []

# This is the tkinter GUI class 
class GraphicDisplay(tk.Tk):
    def __init__(self, value_iteration):
        # Setting the all enviornmental variables
    ...
    def _build_canvas(self):
        # We are adding frontend buttons and images
        ...
        # create grids based on the maximun pixel size
        ...
        canvas.create_image(150, 250, image=self.shapes[2])
        canvas.create_image(250, 250, image=self.shapes[3])
    ...
    def load_images(self):
        ...
        rectangle = PhotoImage(
            Image.open("../img/ramanujan hostel.jpg").resize((65, 65)))
        triangle = PhotoImage(
            Image.open("../img/academic bulding.jpg").resize((65, 65)))
        canteen = PhotoImage(
            Image.open("../img/canteen.jpg").resize((65, 65)))
        circle = PhotoImage(Image.open("../img/circle.jpg").resize((65, 65)))
        return (up, down, left, right), (rectangle, triangle,canteen , circle )

    #Reset the GUI in which all the value_iteration and environmental variables are set to default
    def clear(self):
    ...
    # Based on policy from value_iteration, we are moving the source to dest with the action_list
...
# we can also print the optimal_polcy
...
#Starting the environemnt, putting the rewards for desired grids
class Env:
    def __init__(self):
        ...
        self.reward[2][2] = 1  # reward 1 for destination
        self.reward[1][2] = -1  # reward -1 for canteen
        self.reward[2][1] = -1  # reward -1 for academic block
        self.all_state = []
